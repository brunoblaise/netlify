      ...
      lessons.map(less=>(
        <Link  to={`/s2/${less.id}`}  
         className="L202Xe " key={less.id}>
          <div className="img">
          <svg preserveAspectRatio="xMidYMid meet" id="comp-k8ykrxersvgcontent" data-bbox="48.7 61.6 102.6 90.9" viewBox="48.7 61.6 102.6 90.9" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img" aria-labelledby="comp-k8ykrxer-svgtitle"><title id="comp-k8ykrxer-svgtitle"></title>
  <g>
      ...
      <path fill="#192a88" d="M139.1 67.5l-38.2 13.1-.9.3-.9-.3-38.2-13.1-12.2-4.2v71.6l51.3 17.6 51.3-17.6V63.3l-12.2 4.2z" data-color="2"></path>
        ...
        <h4 className="look1 wrap" >{less.subject}</h4>
